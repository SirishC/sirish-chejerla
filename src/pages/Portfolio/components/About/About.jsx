    ...
    <div>
      <div className="about">
        ...
        <p className="points">
          ...
          automation, and web/mobile applications, leveraging frameworks like
          React.js, Node.js, Flask, and Docker. My expertise extends to
          performance testing, automation, and cybersecurity, making me a
        ...
        <p className="points">
          ...
          staying at the forefront of emerging technologies. When I'm not
